...
import { TbBrandMeta, TbLocation } from "react-icons/tb";
    ...
    <footer className="border-t py-12">
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-4 gap-8 px-4 lg:px-0">
        ...
        <div>
          ...
          <form className="flex">
            <input
              ...
              className="p-3 w-full text-sm border-t border-l border-r border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all"
              required
            />
            <button
              type="Submit"
        ...
        <div>
          ...
          <p className="text-gray-800">
            <FiPhoneCall className="inline-block mr2" />
            <> </>+256 784-325-936
          </p>
          <p className="text-gray-800">
            <TbLocation className="inline-block mr2" />
            <> </>We are located at EM plaza opp. FidoDido along Kampala rd
            Uganda, Shop no.312A
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6">
        <p className="text-gray-400 text-sm  tracking-tighter text-center">
          © {new Date().getFullYear()}, Khadon Store. All Rights Reserved
        </p>
      </div>
    </footer>
  );
